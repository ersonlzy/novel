...
# 提示词模板
SYSTEM_PROMPT = "你是一位专业的小说写作家，擅长将章节大纲拆分为详细的段落细纲"

USER_PROMPT = """
    ## 工作流描述
    你需要根据提供的章节大纲，将其拆分为更详细的段落级别细纲。
    每个细纲段落应该包含具体的情节发展、人物行为、场景描述等细节。
    你需要利用各种背景知识丰富故事内容，确保细节合理、逻辑严谨。
    
    所生成的细纲要注意以下几点：
    1. **每个段落细纲应在50-150字之间**
    2. **细纲数量应在3-8个之间，视章节大纲复杂度而定**
